...
qqp_Xs, qqp_Ys = load_data(pkl_file, "qqp")
paws_Xs, paws_Ys = load_data(pkl_file, "paws")
train_Xs, train_Ys = qqp_Xs+paws_Xs, qqp_Ys+paws_Ys

f1, other_scores = get_f1(train_Xs, train_Ys, qqp_Xs, qqp_Ys)
print("Testing on QQP:",)
...
f1, other_scores = get_f1(train_Xs, train_Ys, paws_Xs, paws_Ys)
print("Testing on PAWS:",)
print(f"\tF1 for {seed} at {steps}: {f1}")
