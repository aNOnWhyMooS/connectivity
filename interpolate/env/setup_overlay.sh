...
OVERLAY=interpolate-torch/interpolate-torch.ext3
...
mkdir interpolate-torch

cp -rp /scratch/work/public/overlay-fs-ext3/overlay-25GB-500K.ext3.gz ./interpolate-torch/

gunzip interpolate-torch/overlay-25GB-500K.ext3.gz

mv interpolate-torch/overlay-25GB-500K.ext3 interpolate-torch/interpolate-torch.ext3
